...
class Flash
{
    public const MESSAGE_KEY = 'shop_key_message';
    public const MESSAGE_CLASS_KEY = 'shop_class_key_message';
    ...
    private function flash(string $message, string $type): void
    {
        ...
        $this->session->flash(self::MESSAGE_CLASS_KEY, config("flash.classes.$type", ''));
    }
}
