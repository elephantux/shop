...
@section('content')
    <x-forms.auth title="Восстановление пароля" action="{{ route('password.email') }}" method="POST">
        ...
        <x-slot:links>
            <div class="space-y-3 mt-5">
                ...
                <div class="text-xxs md:text-xs">
                    <a href="{{ route('signup') }}" class="text-white hover:text-white/70 font-bold">Регистрация</a></div>
            </div>
        </x-slot:links>
